								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="flexslider image-slider">
											<!--SLIDER -->
											<ul class="slides">
												<li><a href="../images/portfolio/thumb/01.jpg" data-fancybox-group="project-slider" class="fancybox"><img src="../images/portfolio/thumb/01.jpg" alt="Project Image"></a></li>
											</ul>
										</div>
										<!--SHARE BUTTONS -->
