			...
			<ul id="left-navigation" class="animate-me fadeInLeftBig">
				...
				<div class="main-container">
					<?php if ( have_posts() ) : ?>
						...
						<?php 
							query_posts( array ( 'category_name' => 'talent', 'posts_per_page' => -1 ) );
						?>
						...
						<?php while ( have_posts() ) : the_post(); ?>
							<?php 
								$talent_Image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'large');
							?>
							<figure class="portfolio-item effect-sadie">
								<img src="<?php echo $talent_Image[0] ?>" alt="event image"/>
								<figcaption>
									<h4><?php the_title();?></h4>
