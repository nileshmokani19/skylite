...
<div class="wrap"> 
	...
	<h2><?php _e('ContactUS Settings','skyliteforms'); ?></h2>
	<form method="post" action="options.php" name="CUGolbalSiteOptions">
		<?php settings_fields( 'cu-fields' ); ?>
		<h3 class="title"><?php _e('Mail Settings','skyliteforms'); ?></h3>
		<table class="form-table" id="email-settings">
			<tbody>
				<tr>
					<th scope="row"><label for="cu_email_address_setting">
					<?php _e('Email Address:','skyliteforms');?>
					</label></th>
					<td><input type="text" name="cu_email_address_setting" class="regular-text" value="<?php echo esc_attr(get_option('cu_email_address_setting'));?>"></td>
				...
				<tr>
					<th scope="row"><label for="cu_subject_text">
					<?php _e('Subject Text:','skyliteforms');?>
					</label></th>
					<td><input type="text" name="cu_subject_text" class="regular-text" value="<?php echo esc_attr(get_option('cu_subject_text'));?>"></td>
					<td><?php _e('<strong>Note:</strong> Default subject text " Skylite DC " will be used.','skyliteforms');?></td>
				</tr>
				<tr>
					<th scope="row"><label for="cu_reply_user_message">
					<?php _e('Reply Message for User:','skyliteforms');?>
					</label></th>
					<td>
					<textarea name="cu_reply_user_message" rows="5" cols="49" class="regular-text"><?php echo esc_attr(get_option('cu_reply_user_message'));?></textarea></td>
				...
				<tr>
					<th scope="row"><label for="cu_custom_css">
					<?php _e('Custom Css:','skyliteforms');?>
					</label></th>
					<td><textarea name="cu_custom_css" rows="5" cols="49" class="regular-text"><?php echo esc_attr(get_option('cu_custom_css'));?></textarea></td>
				...
				<tr>
					<td colspan="3" align="center"><p><?php _e('<strong>Note:</strong> You can add <strong> [sf_contactus_service] </strong> shortcode where you want to display form in pages.','skyliteforms');?>
					<?php  _e(' <br/> OR  You can add <strong> &lt;&#63;php do_shortcode(sf_contactus_service); &#63;&gt;</strong> shortcode in any template.','skyliteforms');?>
					<?php  _e(' <br/> OR  You can add <strong> &lt;&#63;php echo do_shortcode(sf_contactus_service); &#63;&gt;</strong> shortcode in any template.','skyliteforms');?></p></td>
				</tr>
				<tr>
					<td colspan="3"></td>
				</tr>
